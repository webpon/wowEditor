<template>
  <div class="window-title" v-if="!IsUseSysTitle && isNotMac && !IsWeb">
    ...
    <div style="-webkit-app-region: drag" class="logo">
      <img src="@/public/node.svg" class="icon-logo" />
    </div>
    <!-- 菜单栏位置 -->
    <div></div>
    <!-- 中间标题位置 -->
    ...
    <div class="controls-container">
      ...
      <div class="windows-icon-bg" @click="MixOrReduction">
        <img v-if="mix" src="@/assets/icons/svg/reduction.svg" class="icon-size" />
        <img v-else src="@/assets/icons/svg/mix.svg" class="icon-size" />
      </div>
